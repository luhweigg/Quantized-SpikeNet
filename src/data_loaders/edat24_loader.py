...
def get_edat24_loaders(batch_size: int, time_steps: int, num_workers: int = 4, split_seed: int = 42):
    ...
    train_loader = DataLoader(train_subset, batch_size=batch_size, shuffle=True, collate_fn=custom_collate_fn_edat, num_workers=num_workers, pin_memory=True)
    test_loader = DataLoader(test_subset, batch_size=batch_size, shuffle=False, collate_fn=custom_collate_fn_edat, num_workers=num_workers, pin_memory=True)
